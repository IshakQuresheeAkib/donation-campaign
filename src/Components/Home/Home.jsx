    ...
    return (
        <div>
            ...
            <div className="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 my-28 xl:px-36 mx-auto gap-y-7">
                {
                    programs.map(program=> <div key={program.id} className="xl:w-[260px] place-self-center cursor-pointer active:scale-95 duration-500" onClick={()=>navigate(`/donationDetails/${program.id}`)}>
